...
%>
	...
	<form action="up" method="post">
 	...
 	<fieldset>
		...
		<input type="text" name="stype" value="<%= serviceType %>">
		<label>Vehicle category</label>
		<input type="text" name="vehCat" value="<%= vehicleCat %>">
		<label>vehicle No</label>
		<input type="text" name="vehNo" value="<%= vehicleNo %>">
	
		<label>vehicle Model</label>
		<input type="text" name="vehMod" value="<%= vehicleMod %>">
		
		<label>Problem </label>
		<input type="text" name="issue" value="<%= problem %>">
		...
		<input type="text" name="deliveryType" value="<%= deliveryType%>">
	
		<label>Address</label>
		<input type="text" name="paddress" value="<%= address %>">
