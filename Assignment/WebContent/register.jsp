...
<div class="RegisterBody">
	...
	<div id="formStyle1">
		<form action="register" target="_self" method="post" onsubmit="return checkPassword()">
		...
		<legend>Registration Form</legend><br><br>
			...
			<input type="email" id="emailAdd" name="emailAdd" placeholder="enter your emailaddress" required>
			
			
			<label for="MobileNumber">Mobile Number</label>
			<input type="text" id="mobile" name="mobile"  pattern="[0-9]{10}" placeholder="enter your mobile"  required>
			
			
			<label for="lname">Username</label>
  			<input type="text" id="lname" name="lname" placeholder="enter username" required> 
			
			<label for="Password">Password</label>
			<input type="password" id="pwd" name="pwd" placeholder="enter password" required >
			
			<label for="Password">Re-Enter Password</label>
			<input type="password" id="rpwd" name="rpwd" placeholder="Re-enter password" required >
